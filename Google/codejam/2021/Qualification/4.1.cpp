...
vector<int> medianSort(vector<int> a, int l=0, int r=0){
    ...
    vector<int> Left1, Left2, Right;
    int mLeft = a[0];
    Right.push_back(a[2]);

    for(int i=3; i<a.size(); i++){
        int reply = query(mLeft, a[i], middle);
    ...
    vector<int> ansLeft1 = medianSort(Left1, l, middle);
    vector<int> ansLeft2 = medianSort(Left2, mLeft, middle);
